...
- There is no `PrivacyInfo.xcprivacy` file in the Apple project yet. Confirm whether the chosen App Store/TestFlight path requires one for this target and dependencies.
