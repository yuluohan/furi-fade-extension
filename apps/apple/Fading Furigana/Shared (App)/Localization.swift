...
enum L {
    ...
    private static let zhHans: [String: String] = [
        ...
        "Chrome syncs exposure to this Mac over a free local loopback bridge — no Pro needed.": "Chrome 通过免费的本地回环桥把曝光同步到这台 Mac——无需 Pro。",
        "Mac app loopback:": "Mac app 回环：",
        "Pairing code:": "配对码：",
        "Listening on 127.0.0.1:%d": "正在监听 127.0.0.1:%d",
        "Server not running": "服务未运行",
        "New Code": "更换配对码",
        "Enter this code in the Chrome extension popup to connect it to this Mac.": "在 Chrome 扩展弹窗里输入此配对码，即可连接到这台 Mac。",
        "Last connected %@.": "上次连接：%@。",
        "Pairing code copied": "配对码已复制",
        "Generate a new pairing code?": "生成新的配对码？",
        "The Chrome extension will stop syncing until you enter the new code in its popup.": "在 Chrome 扩展弹窗里输入新配对码之前，同步会暂停。",
        "New pairing code generated": "已生成新的配对码",
